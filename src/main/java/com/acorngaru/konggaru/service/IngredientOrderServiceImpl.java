...
public class IngredientOrderServiceImpl implements IngredientOrderService {
    ...
    public int orderAddIngredient(IngredinetOrder ingredient_order) {return mapper.orderAddIngredient(ingredient_order);}
    public List<IngredinetOrder> selectAllOrder() {return mapper.selectAllOrder();}
