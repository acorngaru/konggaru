										...
										.ajax({
											...
											success : function(data, status,
												...
												if (data.mesg == null) {
													...
													var html1 = "";
													html1 += '사번 :'
															+ '<input type="text" id="clockId">';
													html1 += '<a href="#" class="btn btn-success" data-toggle="modal" id="clockIdBtn">'
										...
										.ajax({
											...
											success : function(data, status,
												...
												if (data.mesg == null) {
													...
													html += '사번 :'
															+ '<input type="text" id="clockId">';
													html += '<a href="#" class="btn btn-success" data-toggle="modal" id="ClockIdBtn">'
															+ '<i class="material-icons">';
													html += '&#xE147;' + '</i>'
															+ '<span>' + '입력'
															+ '</span>'
													...
													html2 += '사번 :'
															+ '<input type="text" id="clockId">';
													html2 += '<a href="#" class="btn btn-success" data-toggle="modal" id="ClockIdBtn">'
															+ '<i class="material-icons">';
													html2 += '&#xE147;'
															+ '</i>' + '<span>'
															+ '입력' + '</span>'
										...
										.ajax({
											...
											success : function(data, status,
												...
												if (data.mesg == null) {
													...
													html3 += '사번 :'
															+ '<input type="text" id="clockId">';
													html3 += '<a href="#" class="btn btn-success" data-toggle="modal" id="clockIdBtn">'
															+ '<i class="material-icons">';
													html3 += '&#xE147;'
															+ '</i>' + '<span>'
															+ '입력' + '</span>'
